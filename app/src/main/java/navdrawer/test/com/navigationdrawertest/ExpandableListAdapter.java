...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        if (listPosition == ITEM1)
            listTitleTextIconView.setText(context.getResources().getString(R.string.home));
        else if (listPosition == ITEM2)
            listTitleTextIconView.setText(context.getResources().getString(R.string.take_pencil));
        else if (listPosition == ITEM3)
            listTitleTextIconView.setText(context.getResources().getString(R.string.edit));
        else if (listPosition == ITEM4)
            listTitleTextIconView.setText(context.getResources().getString(R.string.find_def));
        else if (listPosition == ITEM5)
            listTitleTextIconView.setText(context.getResources().getString(R.string.logOut));
